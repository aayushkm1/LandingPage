...
import styles from './testimonial.module.css'; // Only importing for gradient text
...
const TestimonialSection: React.FC = () => {
  ...
  return (
    <div className="bg-white w-full flex flex-col gap-3 lg:gap-8 mx-auto px-[4%] md:px-12 xl:px-20 py-12 md:py-16 lg:py-20">
      <div className="text-center">
        <h2 className="text-3xl text-black md:text-4xl lg:text-5xl font-bold mb-2">
          Proof That <br/>
          <div className="inline-flex items-center gap-3 mx-2">
